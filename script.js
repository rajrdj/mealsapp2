...
if (localStorage.getItem("favouritesList") == null) {
  ...
  // it fetches meals from API and returns them
  ...
  // it show's all meals card in main according to search input value
          ...
          <div id="card" class="card mb-3" style="width: 20rem;">
              ...
              <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between mt-5">
                      ...
                      <button id="main${data.meals[0].idMeal}" class="btn btn-outline-light active" onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="
                      border-radius: 50%"><i class="fa-solid fa-heart"></i></button>
                      </div>
                      </div>
                      </div>
                      `;
                      ...
                      // it adds and removes meals to the favourites list
